...
export const getFloorPlanById = async (floorPlanId: number): Promise<FloorPlanEntity & { seats?: SeatEntity[] } | null> => {
...
export const getFloorPlanByFloorId = async (floorId: number): Promise<FloorPlanEntity & { seats?: SeatEntity[] } | null> => {
...
export const updateFloorPlan = async (
    ...
    // Update seats only, no image overwrite
